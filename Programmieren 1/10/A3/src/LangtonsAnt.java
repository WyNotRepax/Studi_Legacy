	...
	public static void main(String[] args) {
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				AntSimulation simulation = new AntSimulation(world, LangtonsAnt.STEPS, worldPanel);
				simulation.start();
			}
		});
	}
...
class AntWorldPanel extends JPanel {
	...
	AntWorldPanel(World world) {
		...
		this.image = new BufferedImage(world.getSize(), world.getSize(), BufferedImage.TYPE_INT_ARGB);
	}
