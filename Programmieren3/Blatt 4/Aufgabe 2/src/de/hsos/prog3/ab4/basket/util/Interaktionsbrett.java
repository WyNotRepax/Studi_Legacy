package de.hsos.prog3.ab4.basket.util;/* Eine schrecklich verschachtelte Klasse zur einfachen Darstellung
...
public class Interaktionsbrett {
  ...
  private static final Dimension DIM = new Dimension(1280,
      720);
